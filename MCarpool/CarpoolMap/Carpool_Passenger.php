...
<form action="CarpoolServer_Driver.php" method="post" name="form1" target="_blank" id="form1">
  <p><span class="style5">申请人</span>    
    ...
    <input name="textarea" type="text" value="" size="12">
  ...
  <option>女士</option>
    ...
    <input name="textarea3" type="text" value="" size="13">
乘客数目
...
<input name="textarea8" type="text" value="" size="16">
  </span><input name="Get_trace" type="button" id="Get_trace2" value="显示路径" onClick="my_onclick_gettrace()">
<label></label>
  </p>
  <p>
  <label></label>
